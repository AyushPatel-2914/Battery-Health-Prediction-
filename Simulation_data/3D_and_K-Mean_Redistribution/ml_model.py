"""Train and test a battery SOC prediction model from Test simulation data.

This module loads saved tower CSV data, trains a single linear regression
model on a set of towers, and evaluates the trained model on a separate set.
"""
...
# Train a single model over all training tower data.
...
# Estimate residual error for confidence intervals.
